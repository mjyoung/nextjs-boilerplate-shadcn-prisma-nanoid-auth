/*
 * https://github.com/viascom/nanoid-postgres/tree/main
...
CREATE OR REPLACE FUNCTION nanoid(
    prefix text DEFAULT '', -- A prefix to prepend to the generated string.
    size int DEFAULT 14, -- The number of symbols in the NanoId String. Must be greater than 0.
    alphabet text DEFAULT '23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz', -- The symbols used in the NanoId String. Must contain between 1 and 255 symbols.
...
BEGIN
    ...
    RETURN CASE
        WHEN length(prefix) > 0 THEN prefix || '_' || nanoid_optimized(size, alphabet, mask, step)
        ELSE nanoid_optimized(size, alphabet, mask, step)
    END;
END
$$;
